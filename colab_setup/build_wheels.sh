...
echo "⬇️ Downloading causal-conv1d wheel..."
wget -P "$TEMP_WHEEL_DIR" https://github.com/Dao-AILab/causal-conv1d/releases/download/v1.5.2/causal_conv1d-1.5.2+cu12torch2.4cxx11abiFALSE-cp310-cp310-linux_x86_64.whl || echo "⚠️ causal-conv1d download failed"

echo "⬇️ Downloading mamba-ssm wheel..."
wget -P "$TEMP_WHEEL_DIR" https://github.com/state-spaces/mamba/releases/download/v2.2.5/mamba_ssm-2.2.5+cu12torch2.4cxx11abiFALSE-cp310-cp310-linux_x86_64.whl || echo "⚠️ mamba-ssm download failed"
